export const BookCard = ({ book }) => {
  return (
    <div className="p-4 bg-gray-800 rounded-lg shadow-lg w-full text-white relative hover:shadow-xl transition-shadow duration-300 cursor pointer h-[28rem]">
      <div className="relative mb-4 w-full h-72 overflow-hidden rounded-lg hover:scale-105 transition-transform duration-300">
        <img
